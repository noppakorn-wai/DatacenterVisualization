...
/**
 ...
 @author B_MW (Wai & May)
 */
public class FolderQuery implements Queryable
{

    private static final Logger LOG = Logger.getLogger(FolderQuery.class.getName());
    private final Session session;

    public FolderQuery(Session session)
    {
    ...
    {
        LOG.info("Start FolderQuery.run");
        ...
        includeFields.add("childEntity.MOR.val");
        includeFields.add("childEntity.name");
        includeFields.add("childEntity.class");
        includeFields.add("childType");
        ...
        JSONObject json = session.query(Folder.class, includeFields.toArray(new String[0]));
