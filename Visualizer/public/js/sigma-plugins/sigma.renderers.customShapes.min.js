(function () {
	...
	var i = function (a, b, c, d, e) {
		var f = a.cross && a.cross.lineWeight || 5;
		e.moveTo(b - d, c - f),
		e.lineTo(b - d, c + f),
		e.lineTo(b - f, c + f),
		e.lineTo(b - f, c + d),
	...
	var k = function (a, b, c, d, e) {
		...
		e.moveTo(b, c - d);
		for (var k = 0; f > k; k++)
			e.lineTo(b + Math.sin(j + 2 * Math.PI * k / f) * i, c - Math.cos(j + 2 * Math.PI * k / f) * i), e.lineTo(b + Math.sin(2 * Math.PI * (k + 1) / f) * h, c - Math.cos(2 * Math.PI * (k + 1) / f) * h)
	};
	b("star", d(k), e(k));
	...
	e = function (a, d, e, f, g) {
		if (b && a.image && a.image.url) {
			...
			l = a.image.clip || 1,
			m = c[h];
			m || (m = document.createElement("IMG"), m.src = h, m.onload = function () {
				b.refresh()
			}, c[h] = m);
			var n = i > j ? j / i : 1,
			o = j > i ? i / j : 1,
